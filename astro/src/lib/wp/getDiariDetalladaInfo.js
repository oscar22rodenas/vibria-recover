...
export const getDiariDetalladaInfo = async (slug) => {
  try {    
    ...
    const pageId = pageData.acf.diari_boton_link ? await getPageById(pageData.acf.diari_boton_link) : null;

        return {
          content: pageData.content.rendered || "",
          buttonText: pageData.acf.diari_boton_texto || "Más información",
